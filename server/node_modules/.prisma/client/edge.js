...
const config = {
  "generator": {
    ...
    "output": {
      "value": "F:\\vscode workspace\\FullStackMernRealstate\\server\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\") //database should be confidential so provide it in env\n}\n\nmodel User {\n  id               String      @id @default(auto()) @map(\"_id\") @db.ObjectId\n  name             String?\n  email            String      @unique\n  image            String?\n  bookedVisits     Json[]\n  favResidenciesId String[]    @db.ObjectId\n  ownedResidencies Residency[] @relation(\"Owner\")\n}\n\nmodel Residency {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  title       String\n  description String\n  price       Int\n  address     String\n  city        String\n  country     String\n  image       String\n  facilities  Json\n  userEmail   String\n  owner       User     @relation(\"Owner\", fields: [userEmail], references: [email])\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n\n  @@unique(fields: [address, userEmail])\n}\n",
  "inlineSchemaHash": "844ddcd0622bc7d1a7dd50753a5ab573ae75bfc7a10eecc4b9e861cec0548c95",
  "copyEngine": true
}
config.dirname = '/'
